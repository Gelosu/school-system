...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $psaDbPath = "http://localhost/klds/SPORTS/UPLOADS/$name/PSA/$psaFileName";
    $gradeDbPath = "http://localhost/klds/SPORTS/UPLOADS/$name/GRADECOPY/$gradeFileName";
    $schoolIdDbPath = "http://localhost/klds/SPORTS/UPLOADS/$name/SCHOOLID/$schoolIdFileName";
