...
<head>
    ...
    <title>KLD STUDENT ACTIVITIES AND DEVELOPMENT ADMIN</title>
...
<body>
    ...
    <h3>WELCOME STUDACTDEV ADMIN!</h3>

        <ul>
            <li><a href="#chats" onclick="setActiveSection('chats')">Chats</a></li>
            <li><a href="#orgaccount" onclick="setActiveSection('orgaccount')">Student Organizations</a></li>
            <li><a href="#orgaccountlogs" onclick="setActiveSection('orgaccountlogs')">Student Access Logs</a></li>
    ...
    <div class="main-content">
        ...
        <div id="chats" class="section" style="display: none;">
            <?php include 'CHATBOX/chat.php'; ?>
        </div>
         <!-- Chats Section -->
         <div id="orgaccount" class="section" style="display: none;">
            <?php include 'ORGREG/studorg.php'; ?>
        </div>

          <!-- Chats Section -->
          <div id="orgaccountlogs" class="section" style="display: none;">
            <?php include 'ACCESS/accesslog.php'; ?>
        </div>
