    ...
    <table class="table table-hover table-bordered" id="list">
        <?php if ($_SESSION['login_type'] == 1): ?>
            <colgroup>
                <col width="10%">
                <col width="25%">
                <col width="35%" class="truncate-description">
                <col width="20%">
                <col width="10%">
            </colgroup>
        <?php else: ?>
            <colgroup>
                <col width="10%">
                <col width="30%">
                <col width="50%" class="truncate-description">
                <col width="10%">
            </colgroup>
        <?php endif; ?>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="truncate-description"><?php echo strip_tags($desc); ?></td>
                    <?php if ($_SESSION['login_type'] == 1): ?>
                        <td><?php echo isset($uname[$row['user_id']]) ? $uname[$row['user_id']] : "Deleted User"; ?></td>
                    <?php endif; ?>
                    <td class="text-center">
                        <b><?php echo ucwords($row['status']); ?></b>
                    </td>
                    <?php if ($_SESSION['login_type'] == 1): ?>
                        <td class="text-center">
                            <div class="btn-group">
                                <button type="button" class="btn btn-success btn-flat update_status" data-id="<?php echo $row['id']; ?>" data-status="APPROVE">
                                    ✓
                                </button>
                                <button type="button" class="btn btn-danger btn-flat update_status" data-id="<?php echo $row['id']; ?>" data-status="DISAPPROVE">
                                    X
                                </button>
