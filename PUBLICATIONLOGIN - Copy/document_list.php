        ...
        <div class="card-body">
            <table class="table table-hover table-bordered" id="list">
                ...
                <colgroup>
                    <col width="10%">
                    <col width="25%">
                    <col width="35%" class="text-truncate"> <!-- Truncate description column -->
                    <col width="20%">
                    <col width="10%">
                </colgroup>
                <?php else: ?>
                <colgroup>
                    <col width="10%">
                    <col width="30%">
                    <col width="50%" class="text-truncate"> <!-- Truncate description column -->
                    <col width="10%">
                </colgroup>
                <?php endif; ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><b class="text-truncate" style="max-width: 250px; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo strip_tags($desc) ?></b></td>
                        <?php if($_SESSION['login_type'] == 1 ): ?>
...
<style>
	/* Limit the description column's width and truncate the text */
table.dataTable td.truncate-description {
