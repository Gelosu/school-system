...
$id = $_GET['id'];
$fetch_query = mysqli_query($connection, "SELECT * FROM studloa_db WHERE id='$id'");
...
if(isset($_POST['save-student'])) {
    ...
    $update_query = mysqli_query($connection, 
        "UPDATE studloa_db 
         SET NAME='$name', CSYRSC='$csyrcs', DATE='$date', INTERVIEW='$interview', LSTART='$leave_start', REASON='$reason' 
         WHERE id='$id'");
...
<div class="page-wrapper">
    <div class="content">
        <div class="row">
            <div class="col-sm-4">
                <h4 class="page-title">Edit Student Leave of Absence</h4>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label>CSYRSC</label>
                        <input type="text" class="form-control" name="csyrcs" value="<?php echo $row['CSYRSC']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Date</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="interview" value="<?php echo $row['INTERVIEW']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Leave Start Date</label>
                        <input type="date" class="form-control" name="leave_start" value="<?php echo $row['LSTART']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Reason</label>
                        <textarea class="form-control" name="reason" rows="4" required><?php echo $row['REASON']; ?></textarea>
                    </div>
                    <div class="m-t-20 text-center">
                        <button class="btn btn-success submit-btn" name="save-student">Save</button>
                    </div>
                </form>
            </div>
        </div>
